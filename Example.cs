void MArmOS_Configuration() {
    ...
    // repo reference: example.png is the in-game screenshot for this exact arm
    // root is the up-facing base rotor on the white grid sitting partly in the ice

    new Rotor("R1Z", "Z");  // The base rotor faces up, so its axis is Z. No leading solid before root.
